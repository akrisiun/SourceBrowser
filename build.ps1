...
# $os = "win64"
$runningOnWindows = (Test-Path variable:IsWindows) -and $IsWindows
if (!($runningOnWindows) -and (Test-Path variable:IsMacOS) -and $IsMacOS)
{
...
if ($runningOnWindows) {
    ...
    dotnet build src/HtmlGenerator -o $PWD/bin/
}