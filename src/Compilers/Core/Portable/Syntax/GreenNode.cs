    ...
    internal abstract class GreenNode : IObjectWritable, IObjectReadable
    {
            ...
            this(kind, diagnostics)
        {
            if (annotations?.Length > 0)
            {
                ...
                {
                    if (annotation == null) throw new ArgumentException(paramName: name.of(annotations), message: "" /*CSharpResources.ElementsCannotBeNull*/);
                }
        ...
        public IEnumerable<SyntaxAnnotation> GetAnnotations(string annotationKind)
        {
            ...
            {
                throw new ArgumentNullException(name.of(annotationKind));
            }
        ...
        public IEnumerable<SyntaxAnnotation> GetAnnotations(IEnumerable<string> annotationKinds)
        {
            ...
            {
                throw new ArgumentNullException(name.of(annotationKinds));
            }
