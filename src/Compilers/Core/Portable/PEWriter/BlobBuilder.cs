...
namespace Microsoft.Cci
{
    ...
    internal unsafe partial class BlobBuilder
    {
        ...
        public BlobBuilder(int size = DefaultChunkSize)
        {
            if (size < 0)
            {
                throw new ArgumentOutOfRangeException(name.of(size));
            }
        ...
        public void WriteContentTo(Stream destination)
        {
            if (destination == null)
            {
                throw new ArgumentNullException(name.of(destination));
            }
        ...
        public void LinkPrefix(BlobBuilder prefix)
        {
            if (prefix == null)
            {
                throw new ArgumentNullException(name.of(prefix));
            }
        ...
        public void LinkSuffix(BlobBuilder suffix)
        {
            if (suffix == null)
            {
                throw new ArgumentNullException(name.of(suffix));
            }
        ...
        public BlobWriter ReserveBytes(int byteCount)
        {
            if (byteCount < 0)
            {
                throw new ArgumentOutOfRangeException(name.of(byteCount));
            }
        ...
        public int TryWriteBytes(Stream source, int byteCount)
        {
            if (source == null)
            {
                throw new ArgumentNullException(name.of(source));
            }
        ...
        public void WriteUTF16(char[] value)
        {
            if (value == null)
            {
                throw new ArgumentNullException(name.of(value));
            }
