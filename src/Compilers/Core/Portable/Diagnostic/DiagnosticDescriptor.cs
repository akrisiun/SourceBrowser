...
namespace Microsoft.CodeAnalysis
{
    ...
    public sealed class DiagnosticDescriptor : IEquatable<DiagnosticDescriptor>
    {
        ...
        ///         new LocalizableResourceString(name.of(FxCopRulesResources.TypesThatOwnDisposableFieldsShouldBeDisposable), FxCopRulesResources.ResourceManager, typeof(FxCopRulesResources)),
        ///         new LocalizableResourceString(name.of(FxCopRulesResources.TypeOwnsDisposableFieldButIsNotDisposable), FxCopRulesResources.ResourceManager, typeof(FxCopRulesResources)),
            ...
            ImmutableArray<string> customTags)
        {
            ...
            {
                throw new ArgumentException(CodeAnalysisResources.DiagnosticIdCantBeNullOrWhitespace, name.of(id));
            }

            if (messageFormat == null)
            {
                throw new ArgumentNullException(name.of(messageFormat));
            }

            if (category == null)
            {
                throw new ArgumentNullException(name.of(category));
            }

            if (title == null)
            {
                throw new ArgumentNullException(name.of(title));
            }
        ...
        public ReportDiagnostic GetEffectiveSeverity(CompilationOptions compilationOptions)
        {
            ...
            {
                throw new ArgumentNullException(name.of(compilationOptions));
            }
