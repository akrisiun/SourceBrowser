...
namespace Microsoft.CodeAnalysis
{
    internal struct AttributeUsageInfo : IEquatable<AttributeUsageInfo>
    {
        ...
        private static string GetErrorDisplayNameResourceId(AttributeTargets target)
        {
            switch (target)
            {
                case AttributeTargets.Assembly: return name.of(CodeAnalysisResources.Assembly);
                case AttributeTargets.Class: return name.of(CodeAnalysisResources.Class1);
                case AttributeTargets.Constructor: return name.of(CodeAnalysisResources.Constructor);
                case AttributeTargets.Delegate: return name.of(CodeAnalysisResources.Delegate1);
                case AttributeTargets.Enum: return name.of(CodeAnalysisResources.Enum1);
                case AttributeTargets.Event: return name.of(CodeAnalysisResources.Event1);
                case AttributeTargets.Field: return name.of(CodeAnalysisResources.Field);
                case AttributeTargets.GenericParameter: return name.of(CodeAnalysisResources.TypeParameter);
                case AttributeTargets.Interface: return name.of(CodeAnalysisResources.Interface1);
                case AttributeTargets.Method: return name.of(CodeAnalysisResources.Method);
                case AttributeTargets.Module: return name.of(CodeAnalysisResources.Module);
                case AttributeTargets.Parameter: return name.of(CodeAnalysisResources.Parameter);
                case AttributeTargets.Property: return name.of(CodeAnalysisResources.Property);
                case AttributeTargets.ReturnValue: return name.of(CodeAnalysisResources.Return1);
                case AttributeTargets.Struct: return name.of(CodeAnalysisResources.Struct1);
                default:
