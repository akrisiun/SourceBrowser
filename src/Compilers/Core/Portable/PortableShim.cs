    ...
    internal static class PortableShim
    {
        ...
        internal static class Environment
        {
            ...
            internal static Func<string, string> ExpandEnvironmentVariables = Type
                .GetTypeInfo()
                .GetDeclaredMethod(name.of(ExpandEnvironmentVariables), paramTypes: new[] { typeof(string) })
                .CreateDelegate<Func<string, string>>();

            internal static Func<string, string> GetEnvironmentVariable = (Func<string, string>)Type
                .GetTypeInfo()
                .GetDeclaredMethod(name.of(GetEnvironmentVariable), paramTypes: new[] { typeof(string) })
        ...
        internal static class Path
        {
            ...
            internal static readonly char DirectorySeparatorChar = (char)Type
                .GetTypeInfo()
                .GetDeclaredField(name.of(DirectorySeparatorChar))
                .GetValue(null);

            internal static readonly char AltDirectorySeparatorChar = (char)Type
                .GetTypeInfo()
                .GetDeclaredField(name.of(AltDirectorySeparatorChar))
                .GetValue(null);

            internal static readonly Func<string, string> GetFullPath = Type
                .GetTypeInfo()
                .GetDeclaredMethod(name.of(GetFullPath), paramTypes: new[] { typeof(string) })
                .CreateDelegate<Func<string, string>>();

            internal static readonly Func<string> GetTempFileName = (Func<string>)Type
                .GetTypeInfo()
                .GetDeclaredMethod(name.of(GetTempFileName), paramTypes: new Type[] { })
        ...
        internal static class Directory
        {
            ...
            private static readonly MethodInfo s_enumerateDirectories = Type
                .GetTypeInfo()
                .GetDeclaredMethod(name.of("EnumerateDirectories"), new[] { typeof(string), typeof(string), SearchOption.Type });

            private static readonly MethodInfo s_enumerateFiles = Type
                .GetTypeInfo()
                .GetDeclaredMethod(name.of("EnumerateFiles"), new[] { typeof(string), typeof(string), SearchOption.Type });
        ...
        internal static class FileStream
        {
            ...
            internal static readonly PropertyInfo Name = Type
                .GetTypeInfo()
                .GetDeclaredProperty(name.of(Name));
        ...
        internal static class FileVersionInfo
        {
            ...
            internal static // readonly 
                string DesktopName
            {
                get { return String.Format("{0} {1}", TypeName, "System, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089"); }
            }
            ...
            internal static readonly Func<string, object> GetVersionInfo = Type
                .GetTypeInfo()
                .GetDeclaredMethod(name.of(GetVersionInfo), new[] { typeof(string) })
                .CreateDelegate<Func<string, object>>();

            internal static readonly PropertyInfo FileVersion = Type
                .GetTypeInfo()
                .GetDeclaredProperty(name.of(FileVersion));
        }
        ...
        internal static class Thread
        {
            ...
            internal static readonly PropertyInfo CurrentThread = Type
                .GetTypeInfo()
                .GetDeclaredProperty(name.of(CurrentThread));

            internal static readonly PropertyInfo CurrentUICulture = Type
                .GetTypeInfo()
                .GetDeclaredProperty(name.of(CurrentUICulture));

            internal static readonly PropertyInfo ManagedThreadId = Type
                .GetTypeInfo()
                .GetDeclaredProperty(name.of(ManagedThreadId));
        }
        ...
        internal static class Process
        {
            ...
            internal static readonly PropertyInfo Id = Type
                .GetTypeInfo()
                .GetDeclaredProperty(name.of(Id));

            internal static readonly Func<object> GetCurrentProcess = Type
                .GetTypeInfo()
                .GetDeclaredMethod(name.of(GetCurrentProcess), paramTypes: new Type[] { })
        ...
        internal static class RuntimeHelpers
        {
            ...
            internal static readonly Action EnsureSufficientExecutionStack = Type
                .GetTypeInfo()
                .GetDeclaredMethod(name.of(EnsureSufficientExecutionStack), paramTypes: new Type[] { })
        ...
        internal static class Encoding
        {
            ...
            internal static readonly Func<int, System.Text.Encoding> GetEncoding = Type
                .GetTypeInfo()
                .GetDeclaredMethod(name.of(GetEncoding), paramTypes: new[] { typeof(int) })
        ...
        internal static class MemoryStream
        {
            ...
            internal static readonly MethodInfo GetBuffer = Type
                .GetTypeInfo()
                .GetDeclaredMethod(name.of(GetBuffer));
        }
        ...
        internal static class XPath
        {
            internal static class Extensions
            {
                ...
                internal static readonly Func<XNode, string, IEnumerable<XElement>> XPathSelectElements = Type
                    .GetTypeInfo()
                    .GetDeclaredMethod(name.of(XPathSelectElements), new[] { typeof(XNode), typeof(string) })
        ...
        internal static class HashAlgorithm
        {
            ...
            private static readonly MethodInfo s_computeHash_byte = Type
                .GetTypeInfo()
                .GetDeclaredMethod(name.of("ComputeHash"), new[] { typeof(byte[]) });

            private static readonly MethodInfo s_computeHash_byte_int_int = Type
                .GetTypeInfo()
                .GetDeclaredMethod(name.of("ComputeHash"), new[] { typeof(byte[]), typeof(int), typeof(int) });

            private static readonly MethodInfo s_computeHash_stream = Type
                .GetTypeInfo()
                .GetDeclaredMethod(name.of("ComputeHash"), new[] { typeof(Stream) });
        ...
        internal static class SHA1
        {
            ...
            internal static readonly Func<IDisposable> Create = Type
                .GetTypeInfo()
                .GetDeclaredMethod(name.of(Create), new Type[] { })
