...
namespace Microsoft.CodeAnalysis
{
    ...
    public sealed partial class ModuleMetadata : Metadata
    {
        ...
        public static ModuleMetadata CreateFromMetadata(IntPtr metadata, int size)
        {
            ...
            {
                throw new ArgumentNullException(name.of(metadata));
            }

            if (size <= 0)
            {
                throw new ArgumentOutOfRangeException(CodeAnalysisResources.SizeHasToBePositive, name.of(size));
            }
        ...
        public static unsafe ModuleMetadata CreateFromImage(IntPtr peImage, int size)
        {
            ...
            {
                throw new ArgumentNullException(name.of(peImage));
            }
        ...
        public static ModuleMetadata CreateFromStream(Stream peStream, PEStreamOptions options)
        {
            ...
            {
                throw new ArgumentException(CodeAnalysisResources.StreamMustSupportReadAndSeek, name.of(peStream));
            }
        ...
        internal PEModule Module
        {
            get
            {
                if (IsDisposed)
                {
                    throw new ObjectDisposedException(name.of(ModuleMetadata));
                }
