...
namespace Microsoft
{
    ...
    {
        public static string of(this object name)
        {
            return name == null ? "-" : name.ToString() ?? "-empty-";
        }
    }
}
...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    public sealed partial class AnalyzerFileReference : AnalyzerReference, IEquatable<AnalyzerReference>
    {
        ...
        private static readonly string s_diagnosticNamespaceName = string.Format("{0}.{1}.{2}", name.of("Microsoft"), name.of("CodeAnalysis"), name.of("Diagnostics"));
        ...
        public AnalyzerFileReference(string fullPath, IAnalyzerAssemblyLoader assemblyLoader)
        {
            if (fullPath == null)
            {
                throw new ArgumentNullException(name.of(fullPath));
            }

            if (assemblyLoader == null)
            {
                throw new ArgumentNullException(name.of(assemblyLoader));
            }
        ...
        internal void AddAnalyzers(ImmutableDictionary<string, ImmutableArray<DiagnosticAnalyzer>>.Builder builder)
        {
            ...
            catch (Exception e)
            {
                if (this.AnalyzerLoadFailed != null)
                    AnalyzerLoadFailed.Invoke(this, new AnalyzerLoadFailureEventArgs(AnalyzerLoadFailureEventArgs.FailureErrorCode.UnableToLoadAnalyzer, e.Message, e));
                return;
            }
            ...
            {
                if (this.AnalyzerLoadFailed != null)
                    AnalyzerLoadFailed.Invoke(this, new AnalyzerLoadFailureEventArgs(AnalyzerLoadFailureEventArgs.FailureErrorCode.NoAnalyzers, CodeAnalysisResources.NoAnalyzersFound));
            }
        }
        ...
        internal void AddAnalyzers(ImmutableArray<DiagnosticAnalyzer>.Builder builder, string language)
        {
            ...
            {
                if (this.AnalyzerLoadFailed != null)
                    AnalyzerLoadFailed.Invoke(this, new AnalyzerLoadFailureEventArgs(AnalyzerLoadFailureEventArgs.FailureErrorCode.UnableToLoadAnalyzer, e.Message));
                return;
            }
        ...
        private IEnumerable<DiagnosticAnalyzer> GetAnalyzersForTypeNames(Assembly analyzerAssembly, IEnumerable<string> analyzerTypeNames, ref bool reportedError)
        {
            ...
            foreach (var typeName in analyzerTypeNames)
            {
                ...
                {
                    if (this.AnalyzerLoadFailed != null)
                    AnalyzerLoadFailed.Invoke(this, new AnalyzerLoadFailureEventArgs(AnalyzerLoadFailureEventArgs.FailureErrorCode.UnableToCreateAnalyzer, e.Message, e, typeName));
                    reportedError = true;
                    continue;
                }
        ...
        {
            EntityHandle ctor;
            return peModule.IsTargetAttribute(customAttrHandle, s_diagnosticNamespaceName, name.of(DiagnosticAnalyzerAttribute), out ctor);
        }
