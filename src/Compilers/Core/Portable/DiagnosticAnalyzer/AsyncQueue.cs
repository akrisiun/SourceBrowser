...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    internal sealed class AsyncQueue<TElement>
    {
        ...
        public void Enqueue(TElement value)
        {
            ...
            {
                throw new InvalidOperationException($"Cannot call {name.of(Enqueue)} when the queue is already completed.");
            }
        }
        ...
        public void Complete()
        {
            if (!CompleteCore())
            {
                throw new InvalidOperationException($"Cannot call {name.of(Complete)} when the queue is already completed.");
            }
        }
