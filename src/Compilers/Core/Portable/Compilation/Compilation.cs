...
namespace Microsoft.CodeAnalysis
{
    ...
    public abstract partial class Compilation
    {
        ...
        protected static IReadOnlyDictionary<string, string> SyntaxTreeCommonFeatures(IEnumerable<SyntaxTree> trees)
        {
            ...
            foreach (var tree in trees)
            {
                ...
                else
                {
                    ...
                    {
                        throw new ArgumentException("inconsistent syntax tree features", name.of(trees));
                    }
                }
            }
        ...
        internal static void ValidateScriptCompilationParameters(Compilation previousScriptCompilation, Type returnType, ref Type globalsType)
        {
            ...
            {
                throw new ArgumentException(CodeAnalysisResources.ReturnTypeCannotBeValuePointerbyRefOrOpen, name.of(globalsType));
            }

            if (returnType != null && !IsValidSubmissionReturnType(returnType))
            {
                throw new ArgumentException(CodeAnalysisResources.ReturnTypeCannotBeVoidByRefOrOpen, name.of(returnType));
            }
            ...
            if (previousScriptCompilation != null)
            {
                ...
                {
                    throw new ArgumentException(CodeAnalysisResources.TypeMustBeSameAsHostObjectTypeOfPreviousSubmission, name.of(globalsType));
                }
        ...
        internal static void CheckSubmissionOptions(CompilationOptions options)
        {
            ...
            {
                throw new ArgumentException(CodeAnalysisResources.InvalidOutputKindForSubmission, name.of(options));
            }
            ...
            {
                throw new ArgumentException(CodeAnalysisResources.InvalidCompilationOptions, name.of(options));
            }
        }
        ...
        public Compilation AddReferences(IEnumerable<MetadataReference> references)
        {
            if (references == null)
            {
                throw new ArgumentNullException(name.of(references));
            }
        ...
        public Compilation RemoveReferences(IEnumerable<MetadataReference> references)
        {
            ...
            foreach (var r in references.Distinct())
            {
                if (!refSet.Remove(r))
                {
                    throw new ArgumentException($"MetadataReference '{r}' not found to remove", name.of(references));
                }
            }
        ...
        public Compilation ReplaceReference(MetadataReference oldReference, MetadataReference newReference)
        {
            ...
            {
                throw new ArgumentNullException(name.of(oldReference));
            }
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            if (peStream == null)
            {
                throw new ArgumentNullException(name.of(peStream));
            }

            if (!peStream.CanWrite)
            {
                throw new ArgumentException(CodeAnalysisResources.StreamMustSupportWrite, name.of(peStream));
            }

            if (pdbStream != null && !pdbStream.CanWrite)
            {
                throw new ArgumentException(CodeAnalysisResources.StreamMustSupportWrite, name.of(pdbStream));
            }
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            if (baseline == null)
            {
                throw new ArgumentNullException(name.of(baseline));
            }
            ...
            if (edits == null)
            {
                throw new ArgumentNullException(name.of(edits));
            }

            if (isAddedSymbol == null)
            {
                throw new ArgumentNullException(name.of(isAddedSymbol));
            }

            if (metadataStream == null)
            {
                throw new ArgumentNullException(name.of(metadataStream));
            }

            if (ilStream == null)
            {
                throw new ArgumentNullException(name.of(ilStream));
            }

            if (pdbStream == null)
            {
                throw new ArgumentNullException(name.of(pdbStream));
            }
