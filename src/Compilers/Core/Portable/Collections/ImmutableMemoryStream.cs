    ...
    internal sealed class ImmutableMemoryStream : Stream
    {
        ...
        public override long Position
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException(name.of(value));
                }
        ...
        public override long Seek(long offset, SeekOrigin origin)
        {
            ...
            try
            {
                switch (origin)
                {
                    ...
                    default:
                        throw new ArgumentOutOfRangeException(name.of(origin));
                }
            }
            catch (OverflowException)
            {
                throw new ArgumentOutOfRangeException(name.of(offset));
            }
