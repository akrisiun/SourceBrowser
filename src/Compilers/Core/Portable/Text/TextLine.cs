    ...
    public struct TextLine : IEquatable<TextLine>
    {
        ...
        public static TextLine FromSpan(SourceText text, TextSpan span)
        {
            ...
            if (text.Length > 0)
            {
                ...
                {
                    throw new ArgumentOutOfRangeException(name.of(span), CodeAnalysisResources.SpanDoesNotIncludeStartOfLine);
                }
                ...
                {
                    throw new ArgumentOutOfRangeException(name.of(span), CodeAnalysisResources.SpanDoesNotIncludeEndOfLine);
                }
