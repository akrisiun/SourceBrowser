...
namespace Microsoft.CodeAnalysis.Text
{
    ...
    public abstract class SourceText
    {
        ...
        protected SourceText(ImmutableArray<byte> checksum = default(ImmutableArray<byte>), SourceHashAlgorithm checksumAlgorithm = SourceHashAlgorithm.Sha1, SourceTextContainer container = null)
        {
            ...
            {
                throw new ArgumentException(CodeAnalysisResources.InvalidHash, name.of(checksum));
            }
        ...
        internal static void ValidateChecksumAlgorithm(SourceHashAlgorithm checksumAlgorithm)
        {
            ...
            {
                throw new ArgumentException(CodeAnalysisResources.UnsupportedHashAlgorithm, name.of(checksumAlgorithm));
            }
        }
        ...
        public static SourceText From(string text, Encoding encoding = null, SourceHashAlgorithm checksumAlgorithm = SourceHashAlgorithm.Sha1)
        {
            if (text == null)
            {
                throw new ArgumentNullException(name.of(text));
            }
        ...
        public static SourceText From(Stream stream, Encoding encoding = null, SourceHashAlgorithm checksumAlgorithm = SourceHashAlgorithm.Sha1, bool throwIfBinaryDetected = false)
        {
            if (stream == null)
            {
                throw new ArgumentNullException(name.of(stream));
            }

            if (!stream.CanRead || !stream.CanSeek)
            {
                throw new ArgumentException(CodeAnalysisResources.StreamMustSupportReadAndSeek, name.of(stream));
            }
        ...
        public static SourceText From(byte[] buffer, int length, Encoding encoding = null, SourceHashAlgorithm checksumAlgorithm = SourceHashAlgorithm.Sha1, bool throwIfBinaryDetected = false)
        {
            if (buffer == null)
            {
                throw new ArgumentNullException(name.of(buffer));
            }

            if (length < 0 || length > buffer.Length)
            {
                throw new ArgumentOutOfRangeException(name.of(length));
            }
        ...
        internal void CheckSubSpan(TextSpan span)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(name.of(span));
            }
        }
        ...
        public SourceText GetSubText(int start)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(name.of(start));
            }
        ...
        public virtual SourceText WithChanges(IEnumerable<TextChange> changes)
        {
            if (changes == null)
            {
                throw new ArgumentNullException(name.of(changes));
            }
            ...
            foreach (var change in changes)
            {
                ...
                {
                    throw new ArgumentException(CodeAnalysisResources.ChangesMustBeOrderedAndNotOverlapping, name.of(changes));
                }
        ...
        public virtual IReadOnlyList<TextChangeRange> GetChangeRanges(SourceText oldText)
        {
            if (oldText == null)
            {
                throw new ArgumentNullException(name.of(oldText));
            }
        ...
        internal sealed class LineInfo : TextLineCollection
        {
            ...
            public override TextLine this[int index]
            {
                get
                {
                    ...
                    {
                        throw new ArgumentOutOfRangeException(name.of(index));
                    }
            ...
            public override int IndexOf(int position)
            {
                ...
                {
                    throw new ArgumentOutOfRangeException(name.of(position));
                }
