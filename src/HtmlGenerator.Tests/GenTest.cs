...
namespace HtmlGenerator.Tests
{
    ...
    public class GenTest
    {
        ...
        public void TestGen(string[] args, string path = null)
        {
            ...
            var asm3b = Assembly.LoadFile(asmDir + "System.Threading.Tasks.Dataflow.dll");
            Console.WriteLine(asm3b.ToString());
            ...
            Environment.SetEnvironmentVariable("DOTNET_INSTALL_DIR", @"c:\Program Files\dotnet");
            Environment.SetEnvironmentVariable("MSBuildSDKsPath", @"C:\Program Files\dotnet\sdk\2.1.200\Sdks");

            var p = new Program().Prepare(args, true);

            var generator = p.Generate(true);
        ...
        public static string GetSdkPath(string dotnetInstallDir, string version)
