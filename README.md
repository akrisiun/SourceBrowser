...
```
Workspace failed: Msbuild failed when processing the file src/HtmlGenerator/HtmlGenerator.csproj' 
with message: Operation is not supported on this platform.
```

# Dockerfile for cloud (-f netcoreapp2.1)
